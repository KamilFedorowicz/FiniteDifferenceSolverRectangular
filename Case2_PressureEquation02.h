...
void runCase2_PressureEquation02(){
    int nx = 30;
    int ny = 30;
    ...
    solver.solve(1000, 0.0001, scalar_bcs, vector_bcs);
    ...
    // on windows
    CSVExporter::saveToCSVWithCoordinates(grid, eq.getScalarField("Po"), "C:/Users/kfedorowicz/source/repos/project_reveal/csv_files/pressure2D.csv");
    CSVExporter::saveToCSVWithCoordinates(grid, eq.getScalarField("So"), "C:/Users/kfedorowicz/source/repos/project_reveal/csv_files/saturation2D.csv");
